        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-4">
              ...
              <Link href="/auth/login" className="px-4 py-2 text-green-600 border border-green-600 rounded-lg text-sm font-medium hover:bg-green-50">
                Login
              </Link>
              <Link href="/auth/signup" className="px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700">
                Sign Up
              </Link>
            </nav>
          </div>
